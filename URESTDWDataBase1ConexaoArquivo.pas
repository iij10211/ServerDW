...
interface
uses uRESTDWPoolerDB,IniFiles,uDWConstsData,System.SysUtils,Vcl.Dialogs,Data.DB;
type
...
procedure TURESTDWDataBaseConection.ConetaServidor;
var
ArquivoIni : TIniFile;
begin
